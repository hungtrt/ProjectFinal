            ...
            className="w-full sm:w-10/12 md:w-8/12 lg:w-6/12 xl:w-4/12 p-6">
                <form onSubmit={onSubmit} className="bg-white rounded-lg -mt-12 border border-gray-200 p-10">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" name="password" id="password" className={`form-input ${showError(errors, 'password') ? 'border-rose-600 bg-rose-50' : 'border-gray-300 bg-white'}`}  placeholder="Nhập Password..." value={state.password} onChange={onChange} />
                    ...
                    <div>
                        <p>Bạn chưa có tài khoản? <span className="capitalize font-medium text-base text-black"><Link to="/register">đăng ký ngay</Link></span></p>
                    </div>
                </form>
            </motion.div>
         </div>
